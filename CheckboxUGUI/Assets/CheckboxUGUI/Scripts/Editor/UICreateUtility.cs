...
{
    public static class UICreateUtility
    {
        ...
        public static GameObject FindUIPlacement(GameObject selectedObject)
        {
            if (selectedObject != null && selectedObject.GetComponentInParent<Canvas>(true) != null)
            {
